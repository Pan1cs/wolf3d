...
/*   Updated: 2021/03/25 10:44:57 by jnivala          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** 		draw_text(home, "VISIBLE_WALL_DIST", frame,
** 			vec2(frame->wall_x2 * 0.5, 280));
...
** 		draw_text(home, "UNVISIBLE LEFTSIDE", frame,
** 			vec2(frame->wall_x2 * 0.5, 360));
...
** 		draw_text(home, "WALL_FRACT_LEN", frame,
** 			vec2(frame->wall_x2 * 0.5, 400));
