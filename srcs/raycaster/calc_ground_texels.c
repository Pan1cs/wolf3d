...
/*   Updated: 2021/03/25 10:08:57 by jnivala          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	SDL_Surface *tex)
{
	...
	frame->ground_uv_b_l.y = interpolate_points(0.0f,
		sector->floor_bottom_left.y, sector->floor_top_left.y,
		sector->floor_bottom_left.y);
	frame->ground_uv_b_r.x = interpolate_points(0.0f,
		sector->floor_bottom_right.x, sector->floor_top_left.x,
		sector->floor_top_right.x);
...
static void		calc_inverse_of_z(t_sector *sector, t_frame *frame,
	SDL_Surface *tex)
{
